...
function About() {
  return (
    <Layout>
      ...
      <div className="head flex justify-center my-5">
        <h1 className=' text-4xl font-bold mt-5 '>About Me</h1>
      </div>
      <div className="secmain flex justify-center h-fit pb-3 items-center">
        ...
        <h1 className='text-3xl text-[#f834c7] leading-normal font-semibold italic '>I'am Dhiraj kumar tiwari</h1>
         <h2 className='text-xl my-2'>Studying my second year in Computer Science Engineering at Uttaranchal University, Dehradun located in India. I am always ready to have new experiences, meet new people and learn new things. I find the idea of creating value for people and impacting the world through my work delightful.</h2>
        </div>
      </div>
    </Layout>
  )
